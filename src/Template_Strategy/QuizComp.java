...
public class QuizComp extends Game implements Preparation {
    public QuizComp(String Name) {
        super(Name);
    }
    ...
    public void gameEnd() {
        ...
        System.out.println("智力大赛结束!最终成绩：");
        setVisited(true);
        for (int i = 1; i <= 8; ++i) {
    ...
    public void getValue(int no) {
        ...
        double value = (athlete.getSpeed() * 1 + athlete.getBeauty() * 1 + athlete.getIntelligence() * 1.3 + athlete.getSkill() * 1.1) * athlete.getCatState().getState();
